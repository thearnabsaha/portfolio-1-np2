                ...
                <div className="container">
                    <div className="box">
                        <div className="left">
                            ...
                            <Image src="https://images.pexels.com/photos/3585047/pexels-photo-3585047.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500" height="600" width="400"/>
                        </div>
                        <div className="right">
                            <h1>About me</h1>
                            ...
                            <div className="award">
                                <div className="awardImg">
                                    <Image src={award} width={`100`} height={`100`}/>
                                </div>
